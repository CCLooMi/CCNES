...
JSNES.ROM = function (nes) {
    ...
    this.nes_des = "flag:4/U8," +
        ...
        "rom:romCount/[:16384]," +
        "vrom:vromCount/[:4096]";
    this.bitax = new CCBitsyntax(this.nes_des);
...
JSNES.ROM.prototype = {
    ...
    load: function (data) {
        ...
        if (typeof data == 'string') {
            ...
            var oo = this.bitax.convertToObject(data);
            for (var p in oo) {
                this[p] = oo[p];
            }
            this.mapperType = (this.mapperTypeH << 4) | this.mapperTypeL;
        }
